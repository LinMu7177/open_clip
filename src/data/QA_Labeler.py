...
INPUT_DIR = "/mnt/user_data/wenwen/data/clevr/clevr_sample_40000/output_scene"
OUTPUT_DIR = "/mnt/user_data/wenwen/data/clevr/clevr_sample_40000/output_scene_qa"
...
DIRECTION_KEYS = ["above", "below", "front", "behind", "left", "right"]
...
def main():
    ...
    for i, json_file in enumerate(tqdm(json_files, desc="Processing scenes")):
        ...
        out_file_name = base_name + "_qa.json"
